        ...
        <div className="mt-4 flex flex-col items-center gap-1">
          ...
          <div className="flex gap-4 mt-1">
            <a href="https://nico2603.github.io/PersonalPage/" target="_blank" rel="noopener noreferrer" aria-label="Página personal" className="hover:text-primary transition-colors">
              <svg className="w-5 h-5 inline" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zm0 14.5A6.5 6.5 0 1110 3.5a6.5 6.5 0 010 13zm0-11a4.5 4.5 0 100 9 4.5 4.5 0 000-9z"/></svg>
            </a>
