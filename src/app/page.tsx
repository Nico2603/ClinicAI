                ...
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-gray-600 dark:text-gray-400">Sin compromiso, cancela cuando quieras</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-5 h-5 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
                        <svg className="w-3 h-3 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-sm text-gray-600 dark:text-gray-400">Soporte técnico especializado 24/7</span>
                    </div>
                  </div>
                </div>
              </div>
